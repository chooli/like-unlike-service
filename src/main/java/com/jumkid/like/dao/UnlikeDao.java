...
public class UnlikeDao {
    ...
    private static Logger logger = LoggerFactory.getLogger(UnlikeDao.class);

    private final RedisTemplate<String, Object> redisTemplate;

    @Autowired
    public UnlikeDao(RedisTemplate redisTemplate) {
    ...
    private String buildKey(String clientId, String entityName){
        return NS_UNLIKE + NS_SEPARATOR + clientId + NS_SEPARATOR + entityName ;
    }
}
